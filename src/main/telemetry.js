...
class TelemetryBridge extends EventEmitter {
  ...
  _getMockTelemetry() {
    ...
    return {
      ...
      VelocityX: -Math.sin(cars[playerIdx].lapDistPct * Math.PI * 2) * cars[playerIdx].speed,
      VelocityY: Math.cos(cars[playerIdx].lapDistPct * Math.PI * 2) * cars[playerIdx].speed,
